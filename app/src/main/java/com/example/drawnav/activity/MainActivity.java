...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String usersukseslogin = getIntent().getStringExtra("USERNAME");
        ...
        navUsername.setText(" "+usersukseslogin);
        Toast.makeText(getApplicationContext(),"Welcome"+usersukseslogin,Toast.LENGTH_SHORT).show();
